 ...
 */
public class FoodListUIOLD extends JFrame {

    FoodCntl foodCntl;
    /**
     * Creates new form FoodListUI
     */
    public FoodListUIOLD() {
        initComponents();
    }
    public FoodListUIOLD(FoodCntl foodCntl){
    ...
    public void initCustomComponents(){
        ...
        for (int i = 0; i < foodCntl.getFoodList().size(); i++) {
            ...
            if(foodCntl == null)
                System.out.println("Cntl is null");
            if(foodCntl.getFoodList() == null)
                System.out.println("FoodList is null");
            if(foodCntl.getFoodList().getFood(i) == null)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FoodListUIOLD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FoodListUIOLD().setVisible(true);
            }
        });
    }
